...
class GraphicCardAdapter extends TypeAdapter<GraphicCard> {
  @override
  final int typeId = 1;

  @override
  GraphicCard read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, GraphicCard obj) {
    writer
      ..writeByte(7)
      ..writeByte(0)
      ..write(obj.id)
