...
class EmployeeForm extends GetView<EmployeeFormController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EmployeeFormController>(
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        controller.editing ? 'Редактировать сотрудника' : 'Добавить сотрудника',
                        style: TextStyle(
                          fontSize: 36.0
                        ),
                      ),
                          ...
                          children: [
                            Container(
                              ...
                              child: TextFieldCustom(
                                ...
                                onChanged: (text) => controller.surnameTextChanged(text),
                              ),
                            ),
                            Container(
                              width: fieldWidth,
                            ...
                            Container(
                              ...
                              child: TextFieldCustom(
                                labelText: 'Отчество', 
                                initialValue: controller.patronymic, 
                                onChanged: (text) => controller.patronymicTextChanged(text),
                              ),
                            ),
                          ],
                        ),
