...
class ManufacturerForm extends GetView<ManufacturerFormController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ManufacturerFormController>(
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        controller.editing ? 'Редактировать производителя' : 'Добавить производителя',
                        style: TextStyle(
                          fontSize: 36.0
                        ),
                      ),
